...
export default function MallDirectory() {
    ...
    // effect: an effect is a function 
    // that is called when a state variable changes or when the component is
    // rendered for the first time
    // typicallly used to integrate React with other technology.
    // Two arguments
    ...
    return (<>
        ...
        <ul>
        {
            ...
            // the first argument of the map function is a
            // 'mapping function'
